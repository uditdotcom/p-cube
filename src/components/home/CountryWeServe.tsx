  ...
  return (
    <section className="py-16 md:py-20 bg-gradient-to-r from-blue-50 to-indigo-50 overflow-hidden relative">
      <div className="container mx-auto mb-6 md:mb-8">
        <h3 className="text-xl md:text-3xl font-bold text-gray-900 text-center mb-1 md:mb-2 uppercase tracking-wide">
          Countries We Serve
        </h3>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        >
          {duplicatedCountries.map((country, index) => (
            ...
            >
              {/* Image Styling */}
              <div className="w-16 md:w-28 transition-transform duration-300 group-hover:scale-110">
                <img
                  src={country.flag}
              ...
              <p className="text-xs md:text-base font-semibold text-gray-700 group-hover:text-blue-600 transition-colors">
                {country.name}
              </p>
            </div>
          ))}
