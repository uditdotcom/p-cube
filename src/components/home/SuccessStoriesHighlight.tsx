...
export function SuccessStoriesHighlight() {
    ...
    return (
        <section id="success-stories" className="py-16 md:py-28 bg-gradient-to-b from-gray-50 to-white">
            <div className="container">
                ...
                >
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-[#0a192f] mb-3 md:mb-4 uppercase tracking-wider">
                        Success Stories
                    </h2>
