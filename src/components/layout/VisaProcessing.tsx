...
import { FileCheck, Landmark, ShieldAlert, ChevronRight, Stamp, ClipboardCheck, History } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Layout } from '@/components/layout/Layout';

interface VisaRibbon {
  title: string;
  id: number;
}

const visaRibbons: VisaRibbon[] = [
  { id: 1, title: "Permanent Residency (PR) Visas" },
  { id: 2, title: "Skilled Worker Permits (Tier 2)" },
  { id: 3, title: "USA J1 & Trainee Visa Support" },
  { id: 4, title: "Gulf Employment Visa Processing" },
  { id: 5, title: "Student & Internship Visas" }
];
  ...
  return (
    <Layout>
      <div className="bg-white min-h-screen font-sans">
        {/* 1. Visa Hero Banner - Global Gateway Slanted UI */}
        <section className="relative h-[380px] flex items-center bg-[#0a192f] overflow-hidden">
          <img 
            ...
            alt="International Passport and Visa Support"
          />
        ...
        <section className="py-20 container mx-auto px-4">
          <div className="grid grid-cols-12 gap-12 lg:gap-20">
            ...
            {/* LEFT: VISA CATEGORY RIBBONS (JOJO Style) */}
            <div className="col-span-12 lg:col-span-5 order-2 lg:order-1">
              ...
              <div className="mt-12 p-8 bg-green-50 rounded-3xl border border-green-100 flex flex-col items-center text-center">
                 <History className="text-[#148d8d] w-12 h-12 mb-4" strokeWidth={1.5} />
                 <h4 className="font-bold text-[#0a192f] mb-1">High Approval Success</h4>
                 <p className="text-xs text-gray-500 leading-relaxed uppercase tracking-wider">
                   Expertly guiding 15,000+ candidates through complex immigration laws.
                 </p>
              </div>
            </div>

            {/* RIGHT: ABOUT VISA SERVICES */}
            <div className="col-span-12 lg:col-span-7 order-1 lg:order-2 space-y-8">
              <div className="flex items-center gap-4">
                <div className="p-3 bg-[#d4af37]/10 rounded-2xl">
                  <Landmark className="text-[#d4af37] w-10 h-10" strokeWidth={1.5} />
                </div>
                <h3 className="text-2xl md:text-4xl font-black text-[#0a192f] uppercase tracking-tighter leading-none">
                  Navigating Global Borders <br/>With Precision
                </h3>
              </div>

              <div className="prose prose-slate text-gray-600 text-lg leading-relaxed max-w-none space-y-4">
                <p>
                  At <strong>P Cube Consulting</strong>, we understand that securing a job is only half the battle; the real work lies in the documentation. Our visa and immigration division is dedicated to providing end-to-end support, ensuring your transition to an international role is seamless and legally compliant.
                </p>
                <p>
                  With over <strong>12 years of specialized experience</strong>, we provide expert guidance on everything from initial document verification to final embassy stamping. We bridge the gap between world-class talent and the complex immigration requirements of 25+ countries.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 pt-12 mt-12 border-t border-gray-100">
                <div className="flex flex-col items-center text-center group">
                  <div className="p-5 bg-gray-50 rounded-full group-hover:bg-[#d4af37]/10 transition-colors">
                    <ClipboardCheck className="w-10 h-10 text-gray-400 group-hover:text-[#148d8d]" strokeWidth={1} />
                  </div>
                  <span className="mt-4 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] group-hover:text-gray-900">Documentation</span>
                </div>
                <div className="flex flex-col items-center text-center group">
                  <div className="p-5 bg-gray-50 rounded-full group-hover:bg-[#d4af37]/10 transition-colors">
                    <FileCheck className="w-10 h-10 text-gray-400 group-hover:text-[#148d8d]" strokeWidth={1} />
                  </div>
                  <span className="mt-4 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] group-hover:text-gray-900">Compliance</span>
                </div>
                <div className="flex flex-col items-center text-center group">
                  <div className="p-5 bg-gray-50 rounded-full group-hover:bg-[#d4af37]/10 transition-colors">
                    <ShieldAlert className="w-10 h-10 text-gray-400 group-hover:text-[#148d8d]" strokeWidth={1} />
                  </div>
                  <span className="mt-4 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] group-hover:text-gray-900">Legal Support</span>
                </div>
              </div>
              ...
              <div className="pt-8 flex justify-center lg:justify-start">
                <Button className="bg-[#148d8d] hover:bg-[#0a192f] text-white px-12 py-8 rounded-full font-bold text-xl shadow-2xl transition-all hover:scale-105 uppercase">
                  Start Visa Assessment <ChevronRight className="ml-2 w-6 h-6" />
                </Button>
              </div>
            </div>
          </div>
